...
@Component
@AllArgsConstructor
public class PasswordStatusCommand implements Command {
    ...
    public CommandType getCommandType() {
        return CommandType.PASSWORD_STATUS;
    }
    ...
    public SendMessage execute(Update update) {
        ...
        PasswordSettings passwordSettings = passwordService.getSettings(chatId);
